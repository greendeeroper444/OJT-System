...
<div class="container-fluid d-flex justify-content-center flex-column">
    ...
    <form action="<?php echo PARENT_FOLDER ?>/client/addRequest/submit" method="POST" id="addrequest">
            ...
            <div class="card shadow">
                ...
                <div class="card-body d-flex flex-column service-requested-handler">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="on-site" name="service-1" value="On-site Documentation">
                        <label class="custom-control-label" for="on-site"><strong>
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="articleDrafting" name="service-2" value="Article Drafting">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="graphics" name="service-3" value="Graphics and Content Design">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="website" name="service-4" value="Content Updating on the College Website">
        ...
        <div class="cust-margin d-flex justify-content-center ">
            <div class="card shadow">
                ...
                <div class="card-body d-flex flex-column platforms-requested-handler">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="collegeWebsite" name="platform-1" value="College Website: dnsc.edu.ph">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="facebook" name="platform-2" value="Facebook: @officialDNSC">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="twitter" name="platform-3" value="Twitter: @officialDNSC">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="youtube" name="platform-4" value="Youtube: @officialDNSC">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="email" name="platform-5" value="Email Blasting: pio@dnsc.edu.ph">
                    ...
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" id="entryway" name="platform-6" value="College Entryway LED Board">
        ...
        <div class="cust-margin d-flex justify-content-center ">
            <div class="card shadow">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <br>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Provide more details and instructions</label>
...
<script src="<?php echo PARENT_FOLDER ?>/public/js/client/addRequestPage.js"></script>
<?php
